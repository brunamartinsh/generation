	...
	public static void main(String[] args) {
		...
		while(true) {
			if(genero.equals("1") || genero.equals("2") || genero.equals("3")) {
				break;
			}else {System.out.println("Cliente se declara: 1-Masculino 2-Feminino 3-Outros ");
			genero = sc.nextLine();
			}
		}
		if(genero.equals("1")) {
		...
		while(true) {
			if(pagamento.equals("1") || pagamento.equals("2") || pagamento.equals("3")) {
				break;
			}else {System.out.println("Digite o pagamento será: 1-a vista 2- cartão 3-parcelado");
			pagamento = sc.next();
			}
		}
